...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Цената на семинара е 399 евро без ДДС. При специфични изисквания или по-голям обхват, финалната стойност може да бъде уточнена индивидуално след предварителната консултация.',
  },
  {
                ...
                <div className="pt-5 border-t border-brand-medium/50 flex items-end justify-between gap-3">
                  <div>
                    ...
                    <div className="flex items-baseline gap-2">
                      ...
                      <span className="text-xs text-neutral-400 font-semibold">без ДДС</span>
                    </div>
                  </div>
